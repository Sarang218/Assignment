...
import ToggleAndStrategies from './ToggleAndStrategies';

// Date array and strategy array data
...
const App = () => (
  <div>
    <ToggleAndStrategies dateArray={dateArray} strategyArray={strategyArray} />
  </div>
);
